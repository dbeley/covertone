...
{#if $discoveryDrawerOpen}
  <div class="fixed inset-0 z-[60] flex items-end justify-center animate-fade-in md:hidden">
    ...
    ></button>
    <div
      class="relative w-full max-w-lg glass-raised rounded-t-2xl max-h-[80vh] flex flex-col animate-slide-up"
...
<!-- Desktop side panel -->
<aside
  class="hidden md:flex flex-col bg-nav backdrop-blur-xl border-l border-surface overflow-hidden transition-all duration-300 ease-out shrink-0"
