...
{#if visible}
  <button
    class="fixed bottom-20 right-4 z-40 p-3 rounded-full surface-glass shadow-xl shadow-black/10 hover:border-accent/30 active:scale-90 transition-all duration-200 text-text-dim hover:text-text"
    onclick={scrollToTop}
